...
def bert_example(args):
    t_after_parsing = timeit.default_timer()
    print('import', t_after_parsing - t_start)
    ...
    ft_weights.to_cuda()
    t_before_loading = timeit.default_timer()
    print('loading weights', t_before_loading - t_after_parsing)
