...
private:
    ...
    void allocateBuffer(size_t batch_size,
                        ...
                        const bool load_not_alloc = false);
    void freeBuffer() override;

    void initialize(bool tp_comm=true);
    ...
    void init_padded_embedding_kernel_ptr(ParallelGptWeight<T>* gpt_weights);
...
protected:
    ...
    bool padded_embedding_kernel_ptr_inited_;
...
public:
    ParallelGpt(size_t                              max_batch_size,
                ...
                TcpAgent*                           tcp_agent                = nullptr,
                bool                                tp_comm                  = true,
                size_t                              real_layer_num           = -1);
    ...
    int get_step() const {return step_; } // for restoring
    void blockUntilAllParamReady();
};
